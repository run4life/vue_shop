<template>
    <div>
        ...
        <el-card>
            <el-row>
                <el-col>
                    <el-button type="primary" @click="addRoleDialogVisible = true" size=mini>添加角色</el-button>
                </el-col>
            </el-row>
                ...
                <el-table-column type="expand">
                    <template slot-scope="scope">
                        <el-row :class="['bdbottom', i1 === 0 ? 'bdtop' : '', 'vcenter']"
                            ...
                            <el-col :span="5">
                                <el-tag size=mini closable @close="removeRightById(scope.row, item1.id)">
                                ...
                                <el-row :class="[i2 === 0 ? '' : 'bdtop', 'vcenter']"
                                    ...
                                    <el-col :span="18">
                                        <el-tag type="warning" v-for="(item3) in item2.children" :key=item3.id closable
                                            size=mini @close="removeRightById(scope.row, item3.id)">
                                            {{item3.authName}}
                                        </el-tag>
                                    </el-col>
                                </el-row>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button type="danger" icon="el-icon-delete" size=mini @click="removeRoleById(scope.row.id)">
                            删除</el-button>
                        <el-button type="warning" icon="el-icon-setting" @click="showSetRightDialog(scope.row)" size=mini>分配权限
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="添加角色" :visible.sync="addRoleDialogVisible" width="50%" @close="addRoleDialogClosed">
            <el-form :model="addRoleForm" :rules="addRoleFormRules" ref="addRoleFormRef" label-width="100px">
                ...
                <el-form-item label="角色描述" prop="roleDesc" size="mini">
                    <el-input v-model="addRoleForm.roleDesc"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
                <el-button @click="addRoleDialogVisible = false" size=mini>取 消</el-button>
                <el-button type="primary" @click="addRoles" size=mini>确 定</el-button>
            </span>
        </el-dialog>
        <el-dialog title="修改角色" :visible.sync="editRoleDialogVisible" width="50%" @close="editRoleDialogClosed">
            <el-form :model="editRoleForm" :rules="editRoleFormRules" ref="editRoleFormRef" label-width="100px">
                <el-form-item label="角色名称" prop="roleName">
                    <el-input v-model="editRoleForm.roleName" disabled size=mini></el-input>
                </el-form-item>
                <el-form-item label="角色描述" prop="roleDesc">
                    <el-input v-model="editRoleForm.roleDesc" size=mini></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
